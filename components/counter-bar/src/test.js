...
describe('CounterBar', () => {
    ...
    it('renders custom colours on counters', () => {
      const wrapper = mount(
        <CounterBar>
          <CounterBar.Total score={1}>All counters</CounterBar.Total>
          <CounterBar.Counters>
            <CounterBar.Counter score={1} scoreColor="orange" scoreBackgroundColor="blue">
              Counter 1
            </CounterBar.Counter>
          </CounterBar.Counters>
        </CounterBar>
      ...
      const wrapper = mount(
        <HashRouter>
          <CounterBar>
            <CounterBar.Total score={1}>All counters</CounterBar.Total>
            <CounterBar.Counters>
              <CounterBar.Counter score={1} component={Link} to="/courses/1/" active>
                Counter 1
              </CounterBar.Counter>
            </CounterBar.Counters>
          </CounterBar>
  ...
  describe('handles totals as expected', () => {
    it('renders custom colours on totals', () => {
      const wrapper = mount(
        <CounterBar>
          <CounterBar.Total score={1} scoreColor="yellow" scoreBackgroundColor="pink">
            All counters
          </CounterBar.Total>
          <CounterBar.Counters>
            <CounterBar.Counter score={1}>Counter 1</CounterBar.Counter>
    ...
    it('accepts a component for the total', () => {
      const wrapper = mount(
        <HashRouter>
          <CounterBar>
            <CounterBar.Total score={1} component={Link} to="/courses?sort=name'/">
              All counters
            </CounterBar.Total>
            <CounterBar.Counters>
              <CounterBar.Counter score={1}>Counter 1</CounterBar.Counter>
