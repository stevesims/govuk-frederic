...
test(
  'CounterBar: Component renders counters with (active) title',
  assert => {
...
test(
  'CounterBar: Component renders with counters with active values',
  assert => {
...
test(
  'CounterBar: Component renders with counters with disabled counter values',
  assert => {
...
test(
  'CounterBar: CountWrapper triggers onSelect when click is true',
  assert => {
...
test(
  'CounterBar: Counter onSelect called with expected ID on click',
  assert => {
    const handleChange = sinon.spy();
