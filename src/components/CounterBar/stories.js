...
export default ({module}) => {
  storiesOf('unsorted/CounterBar', module)
    .add('default', () =>
      <CounterBar
        listTitle="All counters"
        name="name"
    ...
    .add('Active Counter and Title on click', () => <ControlledCounterBar />)
    .add('Clickable Counters', () => <CounterBar
      listTitle="All counters"
      name="name"
      counters={[
        { id: 'abc', name: 'Counter 1', score: 0 },
    ...
    />)
    .add('CounterBar with padded container', () =>
